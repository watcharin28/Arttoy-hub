          ...
          <div className="mb-6">
            ...
            <div className="mt-2 text-gray-700 space-y-2">
              <div className="flex items-center">
                <span className="w-40 text-base text-gray-500">Category</span>
                <span className="text-lg font-medium text-black">
                  {product.category}
                </span>
              </div>
              <div className="flex items-center">
                <span className="w-40 text-base text-gray-500">Type</span>
                <span className="text-lg font-medium text-black">
                  {product.type === "checked_with_card"
                    ? "Checked with Card"
                    : "Unseal"}
              ...
              <div className="flex items-center">
                <span className="w-40 text-base text-gray-500">Color/Character </span>
                <span className="text-lg font-medium text-black">
                  {product.color}
                </span>
              </div>
              <div className="flex items-center">
                <span className="w-40 text-base text-gray-500">Size</span>
                <span className="text-lg font-medium text-black">
                  {product.size}
                </span>
              </div>
